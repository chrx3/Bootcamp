...
from .views import feriados, form_delvehiculo, form_vehiculo, home, registrate, mostrar,form_modvehiculo, listarcliente, form_cliente, form_modcliente, form_delcliente
